...
SET challenge_day = '07';
SET streamlit_identifier = 'dsmdavid_30days_day_' || $challenge_day ||'_sonnet';
SET file_id = 'day' || $challenge_day || '_sonnet.py';
...
ALTER STREAMLIT dsmdavid_30days_day_07_sonnet  ADD LIVE VERSION FROM LAST;